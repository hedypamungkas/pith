...
vulnerability to use this channel for a private conduct report.

If the conduct is also a software security issue, the same channel doubles as
our [security reporting path](./SECURITY.md).
